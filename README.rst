...
- If using this version of VIP (VaChristiaens). Please cite in addition 
Christiaens et al. 2019 (https://ui.adsabs.harvard.edu/abs/2019MNRAS.486.5819C/abstract), 
where parts of the improvements with respect to the original VIP 
(https://github.com/vortex-exoplanet/VIP) were presented.
