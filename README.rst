...
- If using this version of VIP (VaChristiaens) for additional PCA or forward modeling options, please also cite Christiaens et al. 2019 (https://ui.adsabs.harvard.edu/abs/2019MNRAS.486.5819C/abstract), where parts of the improvements in this branch with respect to the original VIP (https://github.com/vortex-exoplanet/VIP) were presented.
