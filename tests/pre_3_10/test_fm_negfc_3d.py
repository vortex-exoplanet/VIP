...
@parametrize(
    ...
    [
        ...
        (pca_annulus, mcmc_negfc_sampling, 4, True, None, True, "ac"),
        (pca_annulus, nested_negfc_sampling, 4, False, "sum", False, None),
    ],
)
def test_algos(
    injected_cube_position,
    pca_algo,
    negfc_algo,
    ncomp,
    mu_sigma,
