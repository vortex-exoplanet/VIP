...
MOCK_MODULES = ['photutils', 'astropy', 'astropy.stats']
...
htmlhelp_basename = 'VIP-VortexImageProcessingdoc'
...
texinfo_documents = [
    (master_doc, 'VIP-VortexImageProcessing', u'VIP Documentation',
     author, 'VIP-VortexImageProcessing', 'One line description of project.',
     'Miscellaneous'),
]
